# Sensors-Related: Low-Cost Sensor Branch Cleaning
Cleaning and aggregation for the Sensor.Community / UBA (Germany-only) branch.
Not used in the final model -- see `../README.md` for the EEA branch that is.

## Main Scripts
| Script | What it does | Main output |
| --- | --- | --- |
| `01_process_pm_sensors.py` | Cleans PM sensors, keeps Germany-bounding-box readings, and creates hourly/daily/monthly PM tables. | `data/processed/hourly/pm/`, `data/processed/daily_avg/`, `data/processed/monthly_avg/` |
