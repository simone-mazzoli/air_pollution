...
If model reliability itself varies with the same regional characteristics under study, the map could be least trustworthy precisely where exposure inequality is most relevant to assess.
